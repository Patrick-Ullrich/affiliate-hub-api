...
namespace AffiliateHub.Infrastructure.Common
{
    ...
    /// <summary>
    /// Custom Problem Details Factory to get camelCase spelling for ModelValidation
    /// might want to remove this and just disable model validation all together
    /// and do it all through fluent validation instead
    /// </summary>
